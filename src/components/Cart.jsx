...
function Cart() {
      ...
      <div className="flex flex-col gap-4">
        {cart.map((item) => {
          return (
            <div
              key={item._id}
              className="w-[800px] mx-auto bg-white text-black px-4 py-6 rounded-md"
            >
        ...
        <div className="text-center text-3xl">Total Price: ${totalPrice}</div>
        <div className="text-center">
          ...
          <Button
            ...
            className="bg-green-600 px-3 py-2"
          >
            Checkout
          </Button>
        </div>
  ...
  return (
    <div className="container py-6 text-white mx-auto max-w-[1200px] flex flex-col gap-4">
